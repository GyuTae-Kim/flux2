...
KLEIN4B_TEXT_ENCODER_MODEL_SPEC = "huihui-ai/Huihui-Qwen3-4B-abliterated-v2"
...
FLUX2_MODEL_INFO = {
    "flux.2-klein-4b": {
        ...
        "text_encoder_load_fn": lambda device="cuda": load_qwen3_embedder(
            model_spec=KLEIN4B_TEXT_ENCODER_MODEL_SPEC,
            tokenizer_spec=KLEIN4B_TEXT_ENCODER_MODEL_SPEC,
